package project.spring.app.bacr.constants;

import java.net.InetAddress;

public class ApplicationConstants_Bacr {

    public static final String DOMAIN                 = "http://localhost:8080/"            ;  // 도메인
//    public static final String DOMAIN                 = ":8080/project/"            ;  // 도메인
    
    
    public static final String TEMP_DIR_PATH         = "/archery/IO/temp/project/"               ;  // temp
    public static final String UPLOAD_DIR_PATH       = "/archery/IO/project/uploadFile/"         ;  // 파일저장경로
    public static final String UPLOAD_EXCEL_PATH     = "/archery/IO/project/excel/uploadFile/"   ;  // 파일저장경로
    public static final String DOWNLOAD_EXCEL_PATH   = "/archery/IO/project/excel/downloadFile/" ;  // 파일저장경로
