...
@Repository
@Transactional
public class Aprj10010Dao extends AprjDao {
    ...
    public int insertAprj10010Co(AprjModel param) throws CommonException {
        try {
            return sessionConn.update("Aprj10010Query.insertAPRJ10010_10", param);
        } catch ( Exception e) {
            throw new CommonException(e);
        }
    }
    ...
    public int deleteAprj10010Co(AprjModel param) throws CommonException {
        try {
            return sessionConn.update("Aprj10010Query.deleteAPRJ10010_10", param);
        } catch ( Exception e) {
            throw new CommonException(e);
        }
    }
