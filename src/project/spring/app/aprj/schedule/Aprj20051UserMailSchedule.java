...
@Service
public class Aprj20051UserMailSchedule extends AprjService {
    ...
    public void srchAprj20030UserList() throws CommonException {
    	try {
            ...
            List<Aprj20030Model> userList = daoAprj20030.srchAprj20030UserMailList(temp);
            ...
            for ( int i = 0; i < userList.size(); i++ ) {
    			...
    			if ( !userId.equals(temp.getUserId()) ) {
    				if ( mailAddr.length() > 0  ) {
    					sendMail.sendMail(mailAddr, "작업요청 메일", mailCtt);
    				}
