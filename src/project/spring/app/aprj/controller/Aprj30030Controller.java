...
import project.spring.app.aprj.service.Aprj30030Service;
import project.spring.app.zcom.lib.object.CommonException;


@Controller
public class Aprj30030Controller extends AprjController {

    @Autowired
    Aprj30030Service serviceAprj30030;
     ...
     */
    @RequestMapping(ActionConstants_Aprj.ACTION_APRJ30030_40)
    public @ResponseBody Object srchAprj30030List(HttpServletRequest request) throws CommonException {
        ...
        modelAndView.addObject(resultList   , serviceAprj30030.srchAprj30030List(param));
        modelAndView.addObject(resultListCnt, serviceAprj30030.srchAprj30030Cnt (param));

        modelAndView.setViewName(ViewConstants_Aprj.VIEW_APRJ30030_40);
        return returnResponse(modelAndView);
    }
