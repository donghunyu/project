...
import project.spring.app.aprj.service.Aprj30010Service;
import project.spring.app.zcom.lib.object.CommonException;


@Controller
public class Aprj30010Controller extends AprjController {

    @Autowired
    Aprj30010Service serviceAprj30010;
     ...
     */
    @RequestMapping(ActionConstants_Aprj.ACTION_APRJ30010_40)
    public @ResponseBody Object srchAprj30010List(HttpServletRequest request) throws CommonException {
        ...
        modelAndView.addObject(resultList   , serviceAprj30010.srchAprj30010List(param));
        modelAndView.addObject(resultListCnt, serviceAprj30010.srchAprj30010Cnt (param));

        modelAndView.setViewName(ViewConstants_Aprj.VIEW_APRJ30010_40);
        return returnResponse(modelAndView);
    }
