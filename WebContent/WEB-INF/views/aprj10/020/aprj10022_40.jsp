...
<script type="text/javascript">
    ...
    function requestPage(pageNo) {
        ...
        var action = "<%= baseLoc %>/" + "<%= ActionConstants_Aprj.ACTION_APRJ10022_40 %>";
    ...
    function requestDtl(astClId) {
        ...
        var action = "<%= baseLoc %>/" + "<%= ActionConstants_Aprj.ACTION_APRJ10022_41 %>" + getParam();
    ...
    function requestSave() {
        ...
        var action = "<%= baseLoc %>/" + "<%= ActionConstants_Aprj.ACTION_APRJ10022_00 %>";
    ...
    function requestDel() {
        ...
        var action = "<%= baseLoc %>/" + "<%= ActionConstants_Aprj.ACTION_APRJ10022_80 %>";
    ...
    <div class="box modal">
        ...
        <div class="bodyarea">
            ...
            <div class="bodyarea">
                <h4>코드 상세정보</h4>
                <div id="detailLayer">
                    <jsp:include page="./aprj10022_41.jsp" />
                </div>
