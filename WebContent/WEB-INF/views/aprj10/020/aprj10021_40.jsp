...
<script type="text/javascript">
    ...
    function requestPage(pageNo) {
        ...
        var action = "<%= baseLoc %>/" + "<%= ActionConstants_Aprj.ACTION_APRJ10021_40 %>";
    ...
    function requestDtl(userId) {
        ...
        var action = "<%= baseLoc %>/" + "<%= ActionConstants_Aprj.ACTION_APRJ10021_41 %>" + getParam();
    ...
    function requestSave() {
        ...
        var action = "<%= baseLoc %>/" + "<%= ActionConstants_Aprj.ACTION_APRJ10021_00 %>";
    ...
    function requestDel() {
        ...
        var action = "<%= baseLoc %>/" + "<%= ActionConstants_Aprj.ACTION_APRJ10021_80 %>";
    ...
    <div class="box modal">
        ...
        <div class="bodyarea">
            ...
            <div class="bodyarea">
                <h4>업무담당자 상세정보</h4>
                <div id="detailLayer">
                    <jsp:include page="./aprj10021_41.jsp" />
                </div>
