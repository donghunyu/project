...
<script type="text/javascript">
    ...
    function requestPage(pageNo) {
        ...
        var action = "<%= baseLoc %>/" + "<%= ActionConstants_Aprj.ACTION_APRJ10010_90 %>";
     ...
     *  선택값반환
     **************************************************************************/
    function returnDtl(coId, astClId, astClNm) {
        var data = '{'
                 + '"coId"      :"' + coId       +'",'
                 + '"astClId"   :"' + astClId    +'",'
                 + '"astClNm"   :"' + astClNm    +'" '
        ...
        <div class="bodyarea">
            ...
            <!--//filter-->
                    ...
                    <table class="table list">
                        ...
                        <tr style="cursor:pointer;" onclick="returnDtl('<c:out value="${row.coId}"/>', '<c:out value="${row.astClId}"/>', '<c:out value="${row.astClNm}"/>');">
