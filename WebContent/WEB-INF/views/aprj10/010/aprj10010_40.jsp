...
<script type="text/javascript">
    ...
    function requestInit() {
        ...
        requestDtl(coId, astClId);
    }

    /**************************************************************************
     *  상세검색
     **************************************************************************/
    function requestDtl(coId, astClId) {
        if ( !chkDtl() ) {
            return false;
        }
    ...
    function requestSave() {
        ...
        var action = "<%= baseLoc %>/" + "<%= ActionConstants_Aprj.ACTION_APRJ10010_00 %>";
    ...
    function chkSave() {
        ...
        if ( isEmptyObject(document.getElementById(Trim("astClNm                       ")), Trim("자산 구분 명                  ")) ) return false;
    ...
    function requestDel() {
        ...
        var action = "<%= baseLoc %>/" + "<%= ActionConstants_Aprj.ACTION_APRJ10010_80 %>";
    ...
    function downloadExcel() {
        ...
        var action = "<%= baseLoc %>/" + "<%= ActionConstants_Aprj.ACTION_APRJ10010_70 %>";
     ...
     *  check 검색 요청
     **************************************************************************/
    function openAPRJ10011() {
        key  = document.getElementById(Trim("astClId   "));
        name = "자산 구분";
        if ( Trim(key.value) == "" ) {
        ...
        var action = ctx + "/" + "<%= ActionConstants_Aprj.ACTION_APRJ10011_40 %>" + getParam();
        var target = "APRJ10011";
            ...
            <jsp:include page="/include/aprj/menu/naviMenu.jsp" />
                ...
                <div class="bodyarea">
                    ...
                    <div class="filter">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <strong>자산 구분 ID</strong>
                                <p>
                                <input type="text" name="srchAstClId"                  id="srchAstClId"                  value="<c:out value="${srchAstClId                   }"/>" class="w-full" title="자산 구분 ID" />
                                </p>
                            </div>
                            <div class="input-group">
                                <strong>자산 구분 명</strong>
                                <p>
                                <input type="text" name="srchAstClNm"                  id="srchAstClNm"                  value="<c:out value="${srchAstClNm                   }"/>" class="w-full" title="자산 구분 명" />
                                </p>
                            </div>
                    ...
                    <div class="list-top">
                        ...
                        <div class="btnarea">
                            <div class="btn default" title="엑셀업로드" onclick="uploadExcel('AST_CL');return false;">엑셀업로드</div>
                    ...
                    <table class="table list">
                        ...
                        <tr style="cursor:pointer;" onclick="requestDtl('<c:out value="${row.coId}"/>', '<c:out value="${row.astClId}"/>');">
                            <td class="tx-center"><input type="checkbox" name="delKey" id="delKey" title="선택" onclick="selectAll(event);" value="<c:out value="${row.coId}"/>_<c:out value="${row.astClId}"/>"></td>
                            ...
                            <td class="tx-left"  ><c:out value="${row.astClCtt                      }"/></td>
                        </tr>
                        </c:forEach>
                        </tbody>
                    </table>
                ...
                <div class="bodyarea">
		            ...
		            <div id="detailLayer">
		                <jsp:include page="./aprj10010_41.jsp" />
		            </div>
                    <div class="btnarea_bottom">
                        <div class="btn default" title="자산등록" onclick="openAPRJ10011();return false;">자산등록</div>
