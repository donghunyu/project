...
<script type="text/javascript">
    ...
    function requestPage(pageNo) {
        ...
        var action = "<%= baseLoc %>/" + "<%= ActionConstants_Aprj.ACTION_APRJ10011_40 %>";
     ...
     *  상세검색
     **************************************************************************/
    function requestDtl(astId) {
        if ( !chkDtl() ) {
            return false;
        }

        document.getElementById("astId"  ).value = astId;
        var action = "<%= baseLoc %>/" + "<%= ActionConstants_Aprj.ACTION_APRJ10011_41 %>" + getParam();
    ...
    function requestSave() {
        ...
        var action = "<%= baseLoc %>/" + "<%= ActionConstants_Aprj.ACTION_APRJ10011_00 %>";
    ...
    function requestDel() {
        ...
        var action = "<%= baseLoc %>/" + "<%= ActionConstants_Aprj.ACTION_APRJ10011_80 %>";
        ...
        <div class="bodyarea">
            <div class="filter">
                <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <p>
                                    <input type="text" name="astClId"                      id="astClId"                      value="<c:out value="${resultHeader.astClId                       }"/>" title="자산 구분 ID"                 maxlength="10"   class="w-full" readonly="readonly"/>
                                </p>
                            </div>
                            <div class="input-group">
                                <strong>자산 구분 명</strong>
                                <p>
                                    <input type="text" name="astClNm"                      id="astClNm"                      value="<c:out value="${resultHeader.astClNm                       }"/>" title="자산 구분 명"                 maxlength="40"   class="w-full" readonly="readonly"/>
                                </p>
                            </div>
                            <div class="input-group">
                                <strong>자산 ID</strong>
            ...
            <!--//filter-->
                    ...
                    <table class="table list">
                        ...
                        <tr style="cursor:pointer;" onclick="requestDtl('<c:out value="${row.astId}"/>');">
                            <td class="tx-center"><input type="checkbox" name="delKey" id="delKey" title="선택" onclick="selectAll(event);" value="<c:out value="${row.astId}"/>"></td>
            ...
            <div class="bodyarea">
                <h4>코드 상세정보</h4>
                <div id="detailLayer">
                    <jsp:include page="./aprj10011_41.jsp" />
                </div>
