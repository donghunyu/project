...
<script type="text/javascript">
    ...
    function requestPage(pageNo) {
        ...
        var action = "<%= baseLoc %>/" + "<%= ActionConstants_Aprj.ACTION_ZCOM99032_40 %>";
    ...
    function requestInit() {
    	...
    	requestDtl(coId, deptId);
    }

    /**************************************************************************
     *  상세검색
     **************************************************************************/
    function requestDtl(coId, deptId) {
        if ( !chkDtl() ) {
            return false;
        }
        ...
        var action = "<%= baseLoc %>/" + "<%= ActionConstants_Aprj.ACTION_ZCOM99032_41 %>" + getParam();
    ...
    function requestSave() {
        ...
        var action = "<%= baseLoc %>/" + "<%= ActionConstants_Aprj.ACTION_ZCOM99032_00 %>";
    ...
    function chkSave() {
        ...
        if ( isEmptyObject(document.getElementById(Trim("deptId                        ")), Trim("부서 ID                       ")) ) return false;
        if ( isEmptyObject(document.getElementById(Trim("deptNm                        ")), Trim("부서 명                       ")) ) return false;
    ...
    function requestDel() {
        ...
        var action = "<%= baseLoc %>/" + "<%= ActionConstants_Aprj.ACTION_ZCOM99032_80 %>";
    ...
    function downloadExcel() {
        ...
        var action = "<%= baseLoc %>/" + "<%= ActionConstants_Aprj.ACTION_ZCOM99032_70 %>";
     ...
     **************************************************************************/
    function openChart() {
        key  = document.getElementById(Trim("coId   "));
        name = "업체";
        if ( Trim(key.value) == "" ) {
        ...
        var action = ctx + "/" + "<%= ActionConstants_Aprj.ACTION_ZCOM99032_91 %>" + getParam();
        var target = "ZCOM99032_91";
	    ...
	    <jsp:include page="/include/zcom/menu/leftMenu.jsp" />
            ...
            <jsp:include page="/include/zcom/menu/naviMenu.jsp" />
                ...
                <div class="bodyarea">
                    ...
                    <div class="filter">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <strong>상위 부서 ID</strong>
                                <p>
                                <input type="text" name="srchSupDeptId"                id="srchSupDeptId"                value="<c:out value="${srchSupDeptId                 }"/>" class="w-full" title="상위 부서 ID" />
                                </p>
                            </div>
                            <div class="input-group">
                                <strong>상위 부서 명</strong>
                                <p>
                                <input type="text" name="srchSupDeptNm"                id="srchSupDeptNm"                value="<c:out value="${srchSupDeptNm                 }"/>" class="w-full" title="상위 부서 명" />
                                </p>
                            </div>
                    ...
                    <div class="list-top">
                        ...
                        <div class="btnarea">
                            <div class="btn default" title="엑셀업로드" onclick="uploadExcel('DEPT');return false;">엑셀업로드</div>
                    ...
                    <table class="table list">
                        ...
                        <tr style="cursor:pointer;" onclick="requestDtl('<c:out value="${row.coId}"/>', '<c:out value="${row.deptId}"/>');">
                            <td class="tx-center"><input type="checkbox" name="delKey" id="delKey" title="선택" onclick="selectAll(event);" value="<c:out value="${row.coId}"/>_<c:out value="${row.deptId}"/>"></td>
                ...
                <div class="bodyarea">
		            ...
		            <div id="detailLayer">
		                <jsp:include page="./zcom99032_41.jsp" />
		            </div>
                    <div class="btnarea_bottom">
                        <div class="btn default" title="조직도"   onclick="openChart  ();return false;">조직도</div>
