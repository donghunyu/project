                    ...
                    <table class="table form">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th>업무 담당 ID</th>
                                <td>
                                    <div class="btn point-b" title="찾기" onclick="requestPopup('OP_CHRG'); return false;"><i class="i-search"></i>찾기</div>
                                    <input type="text" name="opChrgId"                     id="opChrgId"                     value="<c:out value="${resultObject.opChrgId                      }"/>" title="업무 담당 ID"               maxlength="20"   class="w-p50"  readonly="readonly"/>
                                </td>
                                <th>업무 담당 명</th>
                                <td>
