        ...
        <div class="login_wrap">
            <div class="login_container">
                <div class="login_logo">
                    <h1><img src="../images/login-h1.png" alt="Login"></h1>
                    <h2><img src="../images/logo-h2.png" alt="증적관리시스템"></h2>
                    <p>블럭체인 기법을 활용한 업무 자동분배 및 원스탑 증적관리 솔루션</p>
                </div>
                <div class="login">
                    <form name="form1">
                        ...
                        <div class="login_area">
                            <ul>
                                <li>
                                    <span>아이디</span>
                                    <div class="email">
                                        <input id="userId" name="userId" class="form-control" title="아이디" type="text" placeholder="아이디" format="alpha" required autofocus />
                                    </div>
                                </li>
                                <li>
                                    <span>비밀번호</span>
