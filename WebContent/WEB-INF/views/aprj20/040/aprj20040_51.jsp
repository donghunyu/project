                    ...
                    <table class="table form">
                        ...
                        <tbody>
                            <tr>
                                <th>요청 일련번호</th>
                                <td>
                                    <input type="text" name="reqSerNum"                    id="reqSerNum"                    value="<c:out value="${resultObject.reqSerNum                     }"/>" title="요청 일련번호"                maxlength="22"   class="w-full" readonly="readonly"/>
                                    <input type="hidden" name="reqTypCd"                    id="reqTypCd"                    value="<c:out value="${resultObject.reqTypCd                     }"/>" title="요청 일련번호"                maxlength="22"   class="w-full" readonly="readonly"/>
                                </td>
                            </tr>
                            <tr>
                                <th>요청 내용</th>
                                <td colspan="3">
                                    <textarea          name="reqCtt"                       id="reqCtt"                                                                                               title="요청 내용"                    maxlength="200"  class="w-full" onKeyUp="setMaxLength();"  readonly="readonly"><c:out value="${resultObject.reqCtt}"/></textarea>
                                </td>
                            </tr>
                ...
                <div id="gridLayer">
                    ...
                    <table class="table list" id="item_table">
                        ...
                        <tr>
                            ...
                            <td class="tx-left"  ><a href="#" onclick="requestDelItem(<c:out value="${status.count}"/>); return false;"><img src="<%= imgLoc %>/icon_del.gif"></a></td>
                        </tr>
                        </c:forEach>
                        </tbody>
                    </table>
