...
<script type="text/javascript">
    ...
    function requestPage(pageNo) {
        ...
        var action = "<%= baseLoc %>/" + "<%= ActionConstants_Aprj.ACTION_APRJ20021_40 %>";
     ...
     *  상세검색
     **************************************************************************/
    function requestDtl(astClId) {
        if ( !chkDtl() ) {
            return false;
        }

        document.getElementById("astClId").value = astClId;
        var action = "<%= baseLoc %>/" + "<%= ActionConstants_Aprj.ACTION_APRJ20021_41 %>" + getParam();
    ...
    function requestSave() {
        ...
        var action = "<%= baseLoc %>/" + "<%= ActionConstants_Aprj.ACTION_APRJ20021_00 %>";
    ...
    function chkSave() {
        ...
        if ( isEmptyObject(document.getElementById(Trim("prjId                         ")), Trim("프로젝트 UD                   ")) ) return false;
    ...
    function requestDel() {
        ...
        var action = "<%= baseLoc %>/" + "<%= ActionConstants_Aprj.ACTION_APRJ20021_80 %>";
        ...
        <div class="bodyarea">
            <div class="filter">
                <div class="form-group">
                            ...
                            <div class="input-group">
                                <strong>통제 번호</strong>
                                <p>
                                <input type="text" name="ctrlNum"                      id="ctrlNum"                      value="<c:out value="${resultHeader.ctrlNum                   }"/>" class="w-full" title="통제 번호"     readonly="readonly"/>
                                </p>
                            </div>
                            <div class="input-group">
                                <strong>통제 명</strong>
                                <p>
                                <input type="text" name="ctrlNm"                       id="ctrlNm"                       value="<c:out value="${resultHeader.ctrlNm                    }"/>" class="w-full" title="통제 명"       readonly="readonly"/>
                                </p>
                            </div>
            ...
            <!--//filter-->
                    ...
                    <table class="table list">
                        ...
                        <tr style="cursor:pointer;" onclick="requestDtl('<c:out value="${row.astClId}"/>');">
                            <td class="tx-center"><input type="checkbox" name="delKey" id="delKey" title="선택" onclick="selectAll(event);" value="<c:out value="${row.astClId}"/>"></td>
                ...
                <div class="bodyarea">
                    <h4>자산 구분 상세정보</h4>
                    <div id="detailLayer">
                        <jsp:include page="./aprj20021_41.jsp" />
                    </div>
