...
<script type="text/javascript">
    ...
    function requestPage(pageNo) {
        ...
        var action = "<%= baseLoc %>/" + "<%= ActionConstants_Aprj.ACTION_APRJ20034_90 %>";
     ...
     *  선택값반환
     **************************************************************************/
    function returnDtl(opChrgId, opChrgNm, userId, userNm) {
        var data = '{'
                 + '"opChrgId"  :"' + opChrgId  + '",'
                 + '"opChrgNm"  :"' + opChrgNm  + '",'
                 + '"userId"    :"' + userId    + '",'
        ...
        <div class="bodyarea">
            ...
            <!--//filter-->
                    ...
                    <table class="table list">
                        ...
                        <tr style="cursor:pointer;" onclick="returnDtl('<c:out value="${row.opChrgId}"/>', '<c:out value="${row.opChrgNm}"/>', '<c:out value="${row.userId}"/>', '<c:out value="${row.userNm}"/>');">
