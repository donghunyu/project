...
<script type="text/javascript">
    ...
    function requestPage(pageNo) {
        ...
        var action = "<%= baseLoc %>/" + "<%= ActionConstants_Aprj.ACTION_APRJ20039_50 %>";
    ...
    function openAPRJ20039() {
        ...
        var action = ctx + "/" + "<%= ActionConstants_Aprj.ACTION_APRJ20039_40 %>" + getParam();
        var target = "APRJ20039_40";
            ...
            <!--//filter-->
                ...
                <div class="bodyarea">
                    <div class="btnarea_bottom">
                        <div class="btn default" title="상세보기"      onclick="openAPRJ20039();return false;">상세보기</div>
                    </div>
                </div>
                <!--//bodyarea-->
        </div>
