...
<script type="text/javascript">
    ...
    function requestPage(pageNo) {
        ...
        var action = "<%= baseLoc %>/" + "<%= ActionConstants_Aprj.ACTION_APRJ20038_40 %>";
        ...
        <div class="bodyarea">
            ...
            <!--//filter-->
                    ...
                    <table class="table list">
                        ...
                        <tr style="cursor:pointer;" onclick="requestDtl('<c:out value="${row.prjId}"/>', '<c:out value="${row.ctrlNum}"/>', '<c:out value="${row.astClId}"/>');">
