...
<script type="text/javascript">
    ...
    function requestPage(pageNo) {
        ...
        var action = "<%= baseLoc %>/" + "<%= ActionConstants_Aprj.ACTION_APRJ20035_40 %>";
    ...
    function requestInit() {
        ...
        requestDtl(trnsfSerNum);
    }

    /**************************************************************************
     *  상세검색
     **************************************************************************/
    function requestDtl(trnsfSerNum) {
        if ( !chkDtl() ) {
            return false;
        }
    ...
    function requestSave() {
        ...
        var action = "<%= baseLoc %>/" + "<%= ActionConstants_Aprj.ACTION_APRJ20035_01 %>";
    ...
    function chkSave() {
        ...
        if ( isEmptyObject(document.getElementById(Trim("trnsfSerNum                   ")), Trim("이관 일련번호                 ")) ) return false;
        if ( isEmptyObject(document.getElementById(Trim("trnsfTranCd                   ")), Trim("이관 처리 코드                ")) ) return false;
        if ( isEmptyObject(document.getElementById(Trim("trnsfTranCtt                  ")), Trim("이관 처리 내용                ")) ) return false;
        ...
        <div class="bodyarea">
            ...
            <!--//filter-->
                    ...
                    <table class="table list">
                        ...
                        <tr style="cursor:pointer;" onclick="requestDtl('<c:out value="${row.trnsfSerNum}"/>');">
                            <td class="tx-center"><c:out value="${row.rowNum                        }"/></td>
                            <td class="tx-left"  ><c:out value="${row.trnsfSerNum                   }"/></td>
                            <td class="tx-left"  ><c:out value="${row.opChrgNm                      }"/></td>
                            <td class="tx-left"  ><c:out value="${row.userNm                        }"/></td>
                            <td class="tx-left"  ><c:out value="${row.trnsfOpChrgNm                 }"/></td>
                            <td class="tx-left"  ><c:out value="${row.trnsfUserNm                   }"/></td>
                        </tr>
                        </c:forEach>
                        </tbody>
                    </table>
                ...
                <div class="bodyarea">
                    ...
                    <div id="detailLayer">
                        <jsp:include page="./aprj20035_41.jsp" />
                    </div>
