...
<script type="text/javascript">
    ...
    function requestPage(pageNo) {
        ...
        var action = "<%= baseLoc %>/" + "<%= ActionConstants_Aprj.ACTION_APRJ20039_40 %>";
    ...
    function requestInit() {
        ...
        requestDtl(prjId, ctrlNum, astClId, astId);
    }

    /**************************************************************************
     *  상세검색
     **************************************************************************/
    function requestDtl(prjId, ctrlNum, astClId, astId) {
        if ( !chkDtl() ) {
            return false;
        }
        ...
        var action = "<%= baseLoc %>/" + "<%= ActionConstants_Aprj.ACTION_APRJ20039_41 %>" + getParam();
    ...
    function requestSave() {
        ...
        var action = "<%= baseLoc %>/" + "<%= ActionConstants_Aprj.ACTION_APRJ20039_00 %>";
    ...
    function chkSave() {
        ...
        if ( isEmptyObject(document.getElementById(Trim("astCtt                        ")), Trim("자산 내용                     ")) ) return false;
    ...
    function requestDel() {
        ...
        var action = "<%= baseLoc %>/" + "<%= ActionConstants_Aprj.ACTION_APRJ20039_80 %>";
        ...
        <div class="bodyarea">
            ...
            <!--//filter-->
                    ...
                    <table class="table list">
                        ...
                        <tr style="cursor:pointer;" onclick="requestDtl('<c:out value="${row.prjId}"/>', '<c:out value="${row.ctrlNum}"/>', '<c:out value="${row.astClId}"/>', '<c:out value="${row.astId}"/>');">
                ...
                <div class="bodyarea">
                    ...
                    <div id="detailLayer">
                        <jsp:include page="./aprj20038_41.jsp" />
                    </div>
