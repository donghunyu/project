...
<script type="text/javascript">
    ...
    function requestPage(pageNo) {
        ...
        var action = "<%= baseLoc %>/" + "<%= ActionConstants_Aprj.ACTION_APRJ20033_40 %>";
        ...
        <div class="bodyarea">
            ...
            <!--//filter-->
                    ...
                    <table class="table list">
                        ...
                        <tr style="cursor:pointer;" onclick="requestDtl('<c:out value="${row.prjId}"/>', '<c:out value="${row.ctrlNum}"/>', '<c:out value="${row.astClId}"/>', '<c:out value="${row.opChrgId}"/>');">
                            <td class="tx-center"><input type="checkbox" name="delKey" id="delKey" title="선택" onclick="selectAll(event);" value="<c:out value="${row.coId}"/>_<c:out value="${row.opId}"/>_<c:out value="${row.opSerNum}"/>_<c:out value="${row.prjId}"/>_<c:out value="${row.ctrlNum}"/>_<c:out value="${row.astClId}"/>_<c:out value="${row.opChrgId}"/>"></td>
                ...
                <div class="bodyarea">
                    ...
                    <div id="detailLayer">
                        <jsp:include page="./aprj20033_41.jsp" />
                    </div>
