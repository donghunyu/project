...
<c:if test="${sessionUser.userAuthCd != '1000'}">
                    ...
                    <div class="list-top">
                        ...
                        <div class="btnarea">
                            <div class="btn default" title="엑셀업로드"   onclick="uploadExcel('OP_USER');return false;">엑셀업로드</div>
                            <div class="btn default" title="엑셀다운로드" onclick="downloadExcel(); return false;">엑셀다운로드</div>
                            <div class="btn default" title="엑셀다운로드" onclick="openAPRJ20030_60(); return false;">보고서등록</div>
                        </div>
                    </div>
                ...
                <div class="bodyarea">
                    <h4>업무 상세정보</h4>
                    <div id="detailLayer">
                        <jsp:include page="./aprj20030_51.jsp" />
                    </div>
